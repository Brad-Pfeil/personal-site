...
The stack uses `llama-index` and `pydantic-ai` for structured agent orchestration, with a **Neo4j vector store** powering retrieval-augmented generation so the system stays maintainable as schemas evolve.
